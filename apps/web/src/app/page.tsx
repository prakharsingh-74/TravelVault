  ...
  return (
    <div className="p-8 max-w-6xl mx-auto w-full space-y-8 animate-fade-in relative z-10">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-border-main pb-6">
        ...
        <div className="flex items-center gap-2 text-[11px] font-medium bg-panel-subtle border border-border-main rounded-full px-3 py-1.5 text-text-muted">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        <div className="glass-panel p-5 rounded-2xl flex flex-col justify-between h-32 relative overflow-hidden group">
          ...
          <div className="flex items-center justify-between">
            <span className="text-[10px] font-bold text-text-muted uppercase tracking-wider">Passengers</span>
          ...
          <div className="flex items-baseline justify-between mt-3">
            <span className="text-3xl font-extrabold text-text-title tracking-tight">{passCount}</span>
        ...
        <div className="glass-panel p-5 rounded-2xl flex flex-col justify-between h-32 relative overflow-hidden group">
          ...
          <div className="flex items-center justify-between">
            <span className="text-[10px] font-bold text-text-muted uppercase tracking-wider">Documents</span>
          ...
          <div className="flex items-baseline justify-between mt-3">
            <span className="text-3xl font-extrabold text-text-title tracking-tight">{docCount}</span>
        ...
        <div className="glass-panel p-5 rounded-2xl flex flex-col justify-between h-32 relative overflow-hidden group bg-gradient-to-br from-indigo-500/[0.04] to-violet-500/[0.01] dark:from-indigo-500/[0.04] light:from-indigo-500/[0.02]">
          ...
          <div className="flex items-center justify-between">
            <span className="text-[10px] font-bold text-text-muted uppercase tracking-wider">Vector Memory</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 glass-panel rounded-2xl p-5 flex flex-col justify-between">
          <div>
            <h3 className="text-xs font-bold text-text-title uppercase tracking-wider mb-1">Local Storage Index</h3>
            <p className="text-[11px] text-text-muted">Distribution of local profiles and scanned documents index.</p>
          </div>
          ...
          <div className="my-6 grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
            ...
            <div className="flex justify-center relative">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                <span className="text-lg font-bold text-text-title leading-none">{totalCount}</span>
                <span className="text-[9px] text-text-muted mt-1 uppercase font-semibold">items</span>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between border-b border-border-main pb-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs text-text-muted">Passengers</span>
                </div>
                <span className="text-xs font-semibold text-text-title">{passCount} ({totalCount > 0 ? passPercent : 0}%)</span>
              </div>
              <div className="flex items-center justify-between border-b border-border-main pb-2">
                <div className="flex items-center gap-2">
                  <span className="w-2.5 h-2.5 rounded-full bg-[#3b82f6]"></span>
                  <span className="text-xs text-text-muted">Documents</span>
                </div>
                <span className="text-xs font-semibold text-text-title">{docCount} ({totalCount > 0 ? docPercent : 0}%)</span>
              </div>
        ...
        <div className="glass-panel rounded-2xl p-5 flex flex-col justify-between space-y-4">
          <div>
            <h3 className="text-xs font-bold text-text-title uppercase tracking-wider mb-1">Quick Actions</h3>
            <p className="text-[11px] text-text-muted">Instantly manage or query credentials.</p>
          </div>

          <div className="space-y-2">
            <Link
              href="/passengers?new=true"
              className="flex items-center justify-between p-3 rounded-xl border border-border-main bg-panel-subtle hover:bg-panel-hover transition-all group"
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <span className="text-xs font-semibold text-text-title block">Add Passenger</span>
                  <span className="text-[9px] text-text-muted block mt-0.5">Register a new profile</span>
                </div>
              </div>
              <span className="text-xs text-text-muted group-hover:text-text-title transition-colors">→</span>
            </Link>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <span className="text-xs font-semibold text-text-title block">Upload Document</span>
                  <span className="text-[9px] text-text-muted block mt-0.5">Run local OCR engine scan</span>
                </div>
              </div>
              <span className="text-xs text-text-muted group-hover:text-text-title transition-colors">→</span>
            </Link>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <span className="text-xs font-semibold text-text-title block">AI Assistant Chat</span>
                  <span className="text-[9px] text-text-muted block mt-0.5">Natural language query</span>
                </div>
              </div>
              <span className="text-xs text-text-muted group-hover:text-text-title transition-colors">→</span>
            </Link>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-3">
          <div className="flex justify-between items-center">
            <h2 className="text-xs font-bold text-text-title uppercase tracking-wider">Recent Passengers</h2>
            <Link href="/passengers" className="text-[10px] text-text-muted hover:underline font-semibold">View All</Link>
          </div>
          <div className="glass-panel rounded-2xl p-4 divide-y divide-border-main space-y-3">
            {allPassengers.length === 0 ? (
              <div className="text-center py-6">
                <p className="text-[11px] text-text-muted">No passenger profiles found.</p>
                ...
                return (
                  <div key={p.id} className="flex justify-between items-center pt-3 first:pt-0">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h4 className="text-xs font-bold text-text-title">{p.name}</h4>
                        <p className="text-[10px] text-text-muted">{p.nationality} • {p.gender}</p>
                      </div>
                    </div>
                    <span className={`text-[9px] px-2 py-0.5 rounded font-medium ${p.passport ? 'bg-indigo-500/10 text-indigo-400' : 'bg-input-bg text-text-muted'}`}>
        ...
        <div className="space-y-3">
          <div className="flex justify-between items-center">
            <h2 className="text-xs font-bold text-text-title uppercase tracking-wider">Recent Documents</h2>
            <Link href="/documents" className="text-[10px] text-text-muted hover:underline font-semibold">View All</Link>
          </div>
          <div className="glass-panel rounded-2xl p-4 divide-y divide-border-main space-y-3">
            {allDocs.length === 0 ? (
              <div className="text-center py-6">
                <p className="text-[11px] text-text-muted">No travel documents uploaded.</p>
              ...
              allDocs.slice(0, 4).map((d: any) => {
                ...
                return (
                  <div key={d.id} className="flex justify-between items-center pt-3 first:pt-0">
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-lg bg-input-bg border border-border-main flex items-center justify-center text-text-muted">
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z" />
                        </svg>
                      </div>
                      <div>
                        <h4 className="text-xs font-bold text-text-title">{d.name}</h4>
                        <p className="text-[10px] text-text-muted">{d.type} • Owner: {passenger?.name || 'Unknown'}</p>
                      </div>
                    </div>
